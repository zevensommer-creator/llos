...
| T-029 | P5c：班级 UI + E2E 验收 | doing | trae | 高 | T-017/T-028 | desktop_web：教师建班/邀请码/成员管理/分配/通知/统计 + 学生输码入班/查看分配与截止；api-client Mock 扩展；scripts/e2e-p5.mjs 打通 BUILD_PLAN P5 验收门：教师建班→生成邀请码→学生加入→分配参考 DLC→教师查看统计 |
