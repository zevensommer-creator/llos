...
| T-026 | P4c：学生端 + 市场 UI + E2E 验收 | doing | trae | 高 | T-017/T-025 | desktop_web 先行：市场页/DLC 详情/获取流程/训练入口；E2E 验收门（BUILD_PLAN P4）：注册→市场免费获取参考 DLC→完成训练→可评价；kimi 离席后经 Human 指示由 trae 代管前端线（HANDOFF 已关闭） |
