...
| T-032 | P6c：Studio 向导 UI + E2E 验收 | doing | trae | 高 | T-031 | desktop_web Studio 向导页（粘贴/上传 → 结构化预览表单 → 沙箱试用 → 发布，校验错误教学化）+ api-client Mock studio 方法；scripts/e2e-p6.mjs 打通 BUILD_PLAN P6 验收门：非技术教师从零发布免费 DLC → 市场可获取 → 可训练 |
